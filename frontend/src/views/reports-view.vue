            ...
            <div class="chart-card">
              ...
              <div class="chart-container">
                ...
                <svg width="100%" height="300" class="mock-chart">
                  ...
                  <text x="100" y="270" text-anchor="middle" fill="var(--color-text-secondary)">{{ t('reports.categories.electronics') }}</text>
                  <text x="250" y="270" text-anchor="middle" fill="var(--color-text-secondary)">{{ t('reports.categories.clothing') }}</text>
                  <text x="400" y="270" text-anchor="middle" fill="var(--color-text-secondary)">{{ t('reports.categories.food') }}</text>
                  <text x="550" y="270" text-anchor="middle" fill="var(--color-text-secondary)">{{ t('reports.categories.home') }}</text>
                  <text x="700" y="270" text-anchor="middle" fill="var(--color-text-secondary)">{{ t('common.other') }}</text>
                </svg>
              </div>
            </div>
          </div>
            ...
            <div class="chart-card">
              ...
              <div class="chart-container">
                ...
                <svg width="100%" height="300" class="mock-chart">
                  ...
                  <!-- X-axis labels -->
                  <text x="50" y="270" text-anchor="middle" fill="var(--color-text-secondary)">{{ t('reports.months.jan') }}</text>
                  <text x="150" y="270" text-anchor="middle" fill="var(--color-text-secondary)">{{ t('reports.months.feb') }}</text>
                  <text x="250" y="270" text-anchor="middle" fill="var(--color-text-secondary)">{{ t('reports.months.mar') }}</text>
                  <text x="350" y="270" text-anchor="middle" fill="var(--color-text-secondary)">{{ t('reports.months.apr') }}</text>
                  <text x="450" y="270" text-anchor="middle" fill="var(--color-text-secondary)">{{ t('reports.months.may') }}</text>
                  <text x="550" y="270" text-anchor="middle" fill="var(--color-text-secondary)">{{ t('reports.months.jun') }}</text>
                  <text x="650" y="270" text-anchor="middle" fill="var(--color-text-secondary)">{{ t('reports.months.jul') }}</text>
                  <text x="750" y="270" text-anchor="middle" fill="var(--color-text-secondary)">{{ t('reports.months.aug') }}</text>
                </svg>
              </div>
            </div>
          </div>
